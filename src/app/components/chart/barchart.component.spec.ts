...
describe('Barchart Component inline template',()=>{
    ...
    describe('onResize', ()=>{
          ...
          it('Should call buildSVG', ()=>{
              spyOn(comp, "buildSVG");
              comp.onResize();
              expect(comp.buildSVG).toHaveBeenCalled();
          })
    ...
    describe('ngOnChanges', ()=>{
      it('Does not calls parsePieChartData if allServiceData does not exist',()=>{
        comp.appcomponentdata = {};
        spyOn(comp, "parsePieChartData");
        comp.ngOnChanges();
        expect(comp.parsePieChartData).not.toHaveBeenCalled();
      })

      it('Calls parsePieChartData if allServiceData exist',()=>{
        comp.appcomponentdata = { allServiceData: true }
        spyOn(comp, "parsePieChartData");
        comp.ngOnChanges();
        expect(comp.parsePieChartData).toHaveBeenCalled();
      })
    })
})
